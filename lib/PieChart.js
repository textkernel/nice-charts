...
class PieChart extends React.Component {
    ...
    width(withMargins = false) {
        ...
        if (!withMargins) {
            width -= (this.props.margin.left - this.props.margin.right);
        }
        return width;
    }
    ...
    radius() {
        return (Math.min(this.width(), this.height()) - (this.props.margin.left + this.props.margin.right)) / 2;
    }
    ...
    arc() {
        return d3
            .arc()
            .innerRadius(this.radius() * this.props.innerRadius || 0)
