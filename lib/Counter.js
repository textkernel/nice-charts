...
export default class Counter extends React.Component {
    ...
    componentWillMount() {
        if (!this.props.locale || !(this.props.locale in d3format)) {
            return false;
        }
        d3.formatDefaultLocale(d3format[this.props.locale]);
        d3.timeFormatDefaultLocale(d3timeformat[this.props.locale]);
    ...
    render() {
        return <div className="nc-chart" ref={n => this.cRefs['Counter'] = n} data-value={ this.state.value } data-locale={ this.format(this.state.value) }>
