...
class BarTable extends React.Component {
    ...
    drawChart(update) {
        ...
        if (update) {
            ...
            barGroup.select('.nc-bar__backdrop')
                .transition()
                .duration(500)
                .attr('y', d => this.yChart(this._getLabel(d)))
                .attr('height', this.barHeight());

            barGroup.select('.nc-bar__table-label')
                .transition()
                .duration(500)
            ...
            barGroup.select('.nc-bar__table-value')
                .transition()
                .duration(500)
                .attr('y', d => (this.yChart(this._getLabel(d)) + (this.barHeight() / 2)))
                .text(d => format(d[1]));
