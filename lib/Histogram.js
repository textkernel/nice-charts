...
class Histogram extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            xAxis: merge({}, defaultProps.xAxis, props.xAxis),
            yAxis: merge({}, defaultProps.yAxis, props.yAxis),
    ...
    drawChart() {
        ...
        svg = d3.select(target).append('svg')
            ...
            .attr('class', 'nc-chart__svg nc-chart__bar')
            .append('g')
        ...
        var g = svg.append('g')
            .attr('class', 'nc-bar__wrapper')
            .selectAll('g')
            .data(data)
            .enter()
            .append('g')
            .attr('class', 'nc-bar__group')
        ...
        g
            ...
            .attr('width', binWidth)
            .attr('height', 0)
            .attr('class', 'nc-bar nc-bar--histogram')
    ...
    updateChart() {
        ...
        this.setChartDomain(data, step);
        let barGroup = svg.selectAll('.nc-bar__group');
