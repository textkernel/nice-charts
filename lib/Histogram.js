...
class Histogram extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            nonLinear: this.props.nonLinear || defaultNonLinear,
    ...
    componentDidUpdate(prevProps) {
        ...
        this.setState({
            ...
            margin: Object.assign({}, this.state.margin, this.props.margin),
            ticks: Object.assign({}, this.state.ticks, this.props.ticks),
            nonLinear: this.props.nonLinear || defaultNonLinear
        }, () => {
            if (prevProps.nonLinear !== props.nonLinear) {
                this.drawChart();
                return false;
            }
            this.updateChart();
